...
gulp.task("fonts", () => {
  return gulp
    .src(`${config.SRC_DIR}/assets/fonts/**`)
...
gulp.task("images", () => {
  return gulp
    .src([
      `${config.SRC_DIR}/assets/images/**/*.*`,
      `!${config.SRC_DIR}/assets/images/icons/*.*`
    ])
...
gulp.task("watch", () => {
  ...
  gulp.watch(`${config.SRC_DIR}/assets/images/**/*.*`, gulp.series("images"));
  gulp.watch(`${config.SRC_DIR}/scripts/**/*.js`, gulp.series("scripts"));
  gulp.watch(`${config.SRC_DIR}/assets/fonts/*`, gulp.series("fonts"));
